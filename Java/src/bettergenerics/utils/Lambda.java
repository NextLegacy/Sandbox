...
public final class Lambda 
{
    ...
    public class FuncList<TReturn, T extends IFunc<TReturn>> extends ArrayList<T>
    {
    ...
    public class FuncHashMap<TReturn, TKey, T extends IFunc<TReturn>> extends HashMap<TKey, T>
    {
